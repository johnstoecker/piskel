(function () {
  ...
  ns.LegendController = function (usedColorService) {
    this.usedColorService = usedColorService;
    // this.paletteService = pskl.app.paletteService;
  };

  ns.LegendController.prototype.init = function () {
    ...
    //
    var createLegendButton_ = document.querySelector('.create-legend-button');
    ...
    //
    createLegendButton_.addEventListener('click', this.onCreateLegendClick_.bind(this));
  ...
  // ns.LegendController.prototype.fillPaletteList = function () {
  ...
  // };
  //
  ns.LegendController.prototype.fillColorListContainer = function () {
  ...
  ns.LegendController.prototype.selectPalette = function (paletteId) {
    pskl.UserSettings.set(pskl.UserSettings.SELECTED_PALETTE, paletteId);
  };

  ns.LegendController.prototype.getSelectedPaletteColors_ = function () {
    var colors = [];
  ...
  ns.LegendController.prototype.getSelectedPalette_ = function () {
  ...
  ns.LegendController.prototype.selectNextColor_ = function () {
    this.selectColor_(this.getCurrentColorIndex_() + 1);
  };

  ns.LegendController.prototype.selectPreviousColor_ = function () {
    this.selectColor_(this.getCurrentColorIndex_() - 1);
  };

  ns.LegendController.prototype.getCurrentColorIndex_ = function () {
    var currentIndex = 0;
  ...
  ns.LegendController.prototype.selectColorForKey_ = function (key) {
    var index = parseInt(key, 10);
    index = (index + 9) % 10;
    this.selectColor_(index);
  };

  ns.LegendController.prototype.selectColor_ = function (index) {
    var colors = this.getSelectedPaletteColors_();
  ...
  // ns.LegendController.prototype.onUserSettingsChange_ = function (evt, name, value) {
  //   if (name == pskl.UserSettings.SELECTED_PALETTE) {
  //     this.updateFromUserSettings();
  //   }
  // };
  //
  ns.LegendController.prototype.updateFromUserSettings = function () {
    var paletteId = pskl.UserSettings.get(pskl.UserSettings.SELECTED_PALETTE);
    this.fillColorListContainer();
    this.colorPaletteSelect_.value = paletteId;
  };

  ns.LegendController.prototype.onPaletteSelected_ = function (evt) {
    var paletteId = this.colorPaletteSelect_.value;
    this.selectPalette(paletteId);
    this.colorPaletteSelect_.blur();
  };

  ns.LegendController.prototype.onCreateLegendClick_ = function (evt) {
    $.publish(Events.DIALOG_SHOW, {
      dialogId : 'create-legend'
    });
  };

  ns.LegendController.prototype.onEditPaletteClick_ = function (evt) {
    var paletteId = this.colorPaletteSelect_.value;
    $.publish(Events.DIALOG_SHOW, {
      dialogId : 'create-legend',
      initArgs : paletteId
  ...
  ns.LegendController.prototype.onColorContainerContextMenu = function (event) {
    event.preventDefault();
  };

  ns.LegendController.prototype.onColorContainerMouseup = function (event) {
  ...
  ns.LegendController.prototype.highlightSelectedColors = function () {
  ...
  ns.LegendController.prototype.getColorContainer_ = function (color) {
    return this.colorListContainer_.querySelector('.palettes-list-color[data-color="' + color + '"]');
  };

  ns.LegendController.prototype.removeClass_ = function (cssClass) {
  ...
  ns.LegendController.prototype.onPaletteListUpdated = function () {
    this.fillPaletteList();
    this.updateFromUserSettings();
  };
})();
